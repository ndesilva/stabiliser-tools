...
class Test_Stabiliser_State_Check(unittest.TestCase):
    ...
    def test_is_stab_state_accepts_basis_state(self):
        ...
        self.assertTrue(sc.Stabiliser_From_State_Vector(state).is_stab_state)
    ...
    def test_is_stab_state_rejects_with_incorrect_support_size(self):
        ...
        self.assertFalse(sc.Stabiliser_From_State_Vector(state).is_stab_state)
    ...
    def test_is_stab_state_accpets_with_global_factor_when_flagged(self):
        ...
        self.assertTrue(sc.Stabiliser_From_State_Vector(state, allow_global_factor = True).is_stab_state)
    ...
    def test_get_stab_state_returns_correct_state(self):
        ...
        state = sc.Stabiliser_From_State_Vector(state_vector, allow_global_factor = True).get_stab_state()
    ...
    def test_get_stab_state_raises_error_on_invalid_state(self):
        ...
        state = sc.Stabiliser_From_State_Vector(state_vector, allow_global_factor = True)
    ...
    def test_is_stab_accepts_on_invalid_state_if_flagged(self):
        ...
        state = sc.Stabiliser_From_State_Vector(state_vector, assume_stab_state = True)
